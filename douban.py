...
class crawler():
    ...
    def get_li(self,doc):
        ...
        if page:
            return name, star_con, score, info_list, self.url + page['href']
        return name, star_con, score, info_list, None

    def save(self,name, star_con, score, info):
        wb = Workbook()
    ...
    def start(self):
        ...
        while url:
            ...
            movie, star, level_num, info_list, url = self.get_li(doc)
            name = name + movie
            star_con = star_con + star
            score = score + level_num
            info = info + info_list
        self.save(name, star_con, score, info)
